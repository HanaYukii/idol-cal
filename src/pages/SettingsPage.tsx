    ...
    <div className="p-4">
      ...
      <section className="space-y-3">
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-4">
          <h2 className="text-sm font-medium">Demo 資料</h2>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              className="rounded-md bg-white px-3 py-1.5 text-sm font-medium text-zinc-950 hover:bg-zinc-200 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading || clearing}
              className="rounded-md border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-sm text-zinc-300 hover:bg-zinc-800 disabled:opacity-50"
            >
              {clearing ? '清空中…' : '清空所有資料'}
            </button>
          </div>
